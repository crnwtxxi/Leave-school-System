     ...
     export default {
        ...
        data () {
            return {
                ...
                opinionData:[
                  {value:335, name:'教务处未完成人数'},
                  {value:310, name:'教务处完成人数'}
                ],
                opinion1Data:[
                  {value:300,name:'图书馆未完成人数'},
                  {value:200,name:'图书馆完成人数'}
                ],
                opinion2Data:[
                  {value:300,name:"财务处未完成人数"},
                  {value:200,name:'财务处完成人数'}
                ],
                opinion3Data:[
                  {value:300,name:"后勤未完成人数"},
                  {value:200,name:'后勤完成人数'}
                ]
